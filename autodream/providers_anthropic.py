"""
autodream.providers_anthropic — Anthropic Messages API adapter.
...
def anthropic_chat(
    ...
    *,
    ...
    try:
        ...
        from autodream.llm import ProviderError
        raise ProviderError(
    ...
    if resp.status_code != 200:
        from autodream.llm import ProviderError, classify_http_status
        try:
            err_body = resp.json()
        except Exception:
...
def register() -> None:
    """Register this adapter with the provider dispatch in autodream.llm.

    Call from autodream.providers.register_all() at startup.
    """
    # Deferred import to avoid circular dependency at module level
    from autodream.llm import register_provider_dispatch
