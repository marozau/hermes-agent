...
Write to `planning-artifacts/product-brief-{project_name}-{date}.md`.

Use the `product-brief` template from `~/.hermes/skills/bmad/templates/product-brief.md` if available.
