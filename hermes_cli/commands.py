...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("workflow", "Run a multi-phase agent workflow (research → draft → review, etc.)", "Session",
               aliases=("wf",), args_hint="<goal>"),
    CommandDef("workflows", "Manage workflows — list, show, pause, resume, kill, or export", "Session",
               subcommands=("list", "show", "pause", "resume", "kill", "export"),
               args_hint="[list|show|pause|resume|kill|export] [id]"),
    CommandDef("agents", "Show active agents and running tasks", "Session",
               aliases=("tasks",)),
    CommandDef("checkpoints", "Show workflow checkpoint status (cached vs. active phases)", "Session",
               aliases=("cpts",)),
