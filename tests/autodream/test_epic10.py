...
class TestValidateConsolidationPasses:
    def test_valid_values(self):
        from autodream.dream import validate_consolidation_passes
...
class TestComputeProposalDiff:
    def test_added_only(self):
        from autodream.dream import _compute_proposal_diff, PatchProposal
        prev = []
...
class TestComputeSignalDensity:
    def test_empty_entries(self):
        from autodream.dream import _compute_signal_density
...
class TestResolveDepthDynamicN:
    def test_disabled_returns_manual(self):
        from autodream.dream import resolve_depth_dynamic_n
...
class TestParseProposalsFromLlm:
    def test_parse_yaml_list(self):
        from autodream.dream import _parse_proposals_from_llm
        content = """
- op: add
  type: fact
  target_entry_id: e1
...
class TestExtractContradictions:
    def test_extracts_contradicts_field(self):
        from autodream.dream import _extract_contradictions, PatchProposal
        proposals = [
...
class TestPatchProposalContradicts:
    def test_contradicts_field_present(self):
        from autodream.dream import PatchProposal
...
class TestNfr27Reversibility:
    ...
    def test_dream_manifest_has_multi_pass_fields(self):
        ...
        from autodream.dream import DreamManifest, CostInfo
