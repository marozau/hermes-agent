...
class TestC1MemoryPatchIntegrity:
    ...
    def test_memory_patch_is_valid_yaml_with_category_weights(self, dream_env):
        ...
        """
        import yaml
        from autodream.dream import create_dream_artifact, PatchProposal, CostInfo
        ...
        with mock.patch("autodream.dream._run_consolidation_pass") as mock_pass, \
             mock.patch("autodream.memory.build_hit_rate_report", return_value={"sessions": 28}), \
             mock.patch("autodream.memory.propose_category_weight_nudges", return_value=mock_nudges):
...
class TestC2BaselineComparisonOrdering:
    ...
    def test_baseline_reads_written_patch(self, dream_env):
        """C2: baseline comparison runs after memory.patch is written."""
        from autodream.dream import create_dream_artifact, CostInfo, BaselineComparison, PatchProposal
        ...
        with mock.patch("autodream.dream._run_consolidation_pass") as mock_pass, \
             mock.patch("autodream.dream._run_baseline_comparison", return_value=cmp) as mock_baseline:
...
class TestC3CacheBreakpoints:
    ...
    def test_prompt_builder_returns_message_list(self):
        ...
        from autodream.dream import _build_consolidation_prompt
    ...
    def test_refine_prompt_returns_message_list(self):
        ...
        from autodream.dream import _build_refine_prompt
    ...
    def test_cache_breakpoints_set_on_spec(self):
        ...
        from autodream.dream import _run_consolidation_pass
        ...
        with mock.patch("autodream.llm.llm_call", side_effect=mock_llm_call):
...
class TestE2EMultiPass:
    ...
    def test_multi_pass_with_category_weights(self, dream_env):
        ...
        from autodream.dream import create_dream_artifact, CostInfo, PatchProposal
        ...
        from autodream.dream import BaselineComparison
        cmp = BaselineComparison()
        cmp.single_pass_top1 = 0.30
        cmp.multi_pass_top1 = 0.55
        cmp.delta = 0.25
        ...
        with mock.patch("autodream.dream._run_consolidation_pass", side_effect=mock_consolidation_pass), \
             mock.patch("autodream.dream._run_baseline_comparison", return_value=cmp):
