"""Tests for autodream.providers_chat — DeepSeek/OpenAI shared adapter."""
...
class TestImport:
    ...
    def test_import(self):
        ...
        assert autodream.providers_chat.register is not None
        assert autodream.providers_chat.chat_completions is not None

    def test_register_wires_both(self):
        import autodream.llm
        from autodream.providers_chat import register

        # Clean slate
        autodream.llm._PROVIDER_DISPATCH.pop("deepseek", None)
        autodream.llm._PROVIDER_DISPATCH.pop("openai", None)
...
class TestRequestBody:
    ...
    def test_basic_request(self, deepseek_spec, sample_messages):
        ...
        from autodream.providers_chat import chat_completions
