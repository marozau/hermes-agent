...
def _run_dispatch_inline():
    ...
    import autodream.verify_dispatch as _vd
...
class TestDispatchSelfReport:
    ...
    def test_hit_match_calls_reinforce(self, tmp_path):
        ...
        with mock.patch("autodream.memory.reinforce_entry") as mock_reinforce:
    ...
    def test_miss_match_emits_telemetry(self, tmp_path):
        ...
        with mock.patch("autodream.verify_dispatch._emit_verify_citation") as mock_emit:
            dispatch_self_report(report, session_id="test-session-1")
    ...
    def test_trajectory_new_entry(self, tmp_path):
        ...
        with mock.patch("autodream.memory.add_entry", return_value="01HNEW") as mock_add, \
             mock.patch("autodream.memory.classify_trajectory_with_manifest",
    ...
    def test_failure_below_threshold_dropped(self, tmp_path):
        ...
        with mock.patch("autodream.memory.add_entry") as mock_add:
            dispatch_self_report(report, session_id="test-session-1")
...
"""
        ...
        with mock.patch("autodream.memory.reinforce_entry") as mock_reinforce, \
             mock.patch("autodream.memory.add_entry") as mock_add, \
             mock.patch("autodream.memory.classify_trajectory_with_manifest",
                        return_value={"action": "new"}):
            on_post_llm_call(
...
class TestDispatchErrorPaths:
    ...
    def test_build_manifest_failure(self):
        ...
        with mock.patch("autodream.memory.build_manifest", side_effect=RuntimeError("boom")), \
             mock.patch("autodream.memory.classify_trajectory_with_manifest",
    ...
    def test_reinforce_entry_failure_ignored(self):
        ...
        with mock.patch("autodream.memory.reinforce_entry",
    ...
    def test_trajectory_new_add_entry_failure(self):
        ...
        with mock.patch("autodream.memory.add_entry",
    ...
    def test_trajectory_unknown_action(self):
        ...
        with mock.patch("autodream.memory.add_entry") as mock_add, \
             mock.patch("autodream.memory.reinforce_entry") as mock_reinforce, \
             mock.patch("autodream.memory.classify_trajectory_with_manifest",
    ...
    def test_classify_failure_continues(self):
        ...
        with mock.patch("autodream.memory.classify_trajectory_with_manifest",
    ...
    def test_emit_verify_citation_write_failure(self, tmp_path):
        ...
        from autodream.verify_dispatch import _emit_verify_citation
    ...
    def test_emit_trajectory_outcome_write_failure(self, tmp_path):
        ...
        from autodream.verify_dispatch import _emit_trajectory_outcome
...
class TestDedupAndEdgeCases:
    ...
    def test_file_lock_exception_handled(self):
        ...
        from autodream.verify_dispatch import _file_lock, _file_unlock
        import io
    ...
    def test_derive_project_role_exception_path(self):
        ...
        from autodream.verify_dispatch import _derive_project_role
    ...
    def test_derive_role_from_profile_path(self):
        ...
        with mock.patch("autodream.verify_dispatch.get_hermes_home",
    ...
    def test_derive_role_exception_path(self):
        ...
        with mock.patch("autodream.verify_dispatch.get_hermes_home", return_value=BadPath()):
            project, role = _derive_project_role()
