"""Tests for hermes_providers_anthropic — Anthropic adapter with cache_control."""
...
class TestImport:
    ...
    def test_import(self):
        ...
        assert hermes_providers_anthropic.register is not None
        assert hermes_providers_anthropic.anthropic_chat is not None

    def test_register_wires_dispatch(self):
        import hermes_llm
        from hermes_providers_anthropic import register
        ...
        assert hermes_llm._PROVIDER_DISPATCH["anthropic"] is not None
...
class TestCacheBreakpoints:
    ...
    def test_cache_breakpoints_applied(self, anthropic_spec, three_block_messages):
        ...
        from hermes_providers_anthropic import anthropic_chat
